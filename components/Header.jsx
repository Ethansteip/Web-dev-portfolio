    ...
    <div className="w-full h-auto text-center mt-16 mb-16 md:mt-32 md:mb-32">
      <div className="max-w-[1240px] w-full h-full mx-auto p-2 flex flex-col justify-center items-center">
        <div>
          ...
          <p className="uppercase text-xs md:text-sm tracking-widest mb-3 mt-3">Solutions driven ecommerce manager, recent bootcamp graduate<br></br>and aspiring full-stack web developer.</p>
        </div>
        <div>
