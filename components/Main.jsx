    ...
    <div className="w-full h-1/2 text-center">
      <div className="max-w-[1240px] w-full h-full mx-auto p-2 flex flex-col justify-center items-center">
        <div>
          ...
          <p className="uppercase text-sm tracking-widest text-gray-600 mb-3 mt-3">Solutions driven ecommerce manager, recent bootcamp graduate<br></br>and aspiring full-stack web developer.</p>
        </div>
        <div>
