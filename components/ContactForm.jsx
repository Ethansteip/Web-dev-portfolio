...
<div id="contact-form" className="flex items-center min-h-screen">
    ...
    <div className="max-w-xl mx-auto my-10 p-5 rounded-md shadow-sm">
      ...
      <div className="m-7">
        <form action="https://api.web3forms.com/submit" method="POST" id="form">
          ...
          <div className="mb-6">
            <button type="submit" className="w-full px-3 py-4 text-white bg-primary rounded-md focus:bg-indigo-600 focus:outline-none">
              Send Message
            </button>
          </div>
